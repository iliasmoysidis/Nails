...
public sealed class StoreOfferingRemoval
{
    ...
    public StoreOfferingRemoval(Store store, Assignments assignments, StoreCatalog catalog)
    {
    ...
    private static void ValidateComposition(Store store, Assignments assignments, StoreCatalog catalog)
    {
