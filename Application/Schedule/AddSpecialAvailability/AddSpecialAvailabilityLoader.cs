...
public sealed class AddSpecialAvailabilityLoader
    : IRequestContextLoader<AddSpecialAvailabilityCommand, AddSpecialAvailabilityContext>
{
    ...
    public AddSpecialAvailabilityLoader(
