...
public sealed class ConfirmPolicy : IConfirmPolicy
{
    ...
    public ConfirmPolicy(IAppointmentRepository appointmentRepo, IStaffRepository staffRepo, IRequestContext context)
    {
        _context = context;
    ...
    public async Task EnsureCanConfirmAsync(ConfirmCommand command, CancellationToken ct)
    {
