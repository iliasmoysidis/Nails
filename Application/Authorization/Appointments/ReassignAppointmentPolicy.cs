...
public sealed class ReassignAppointmentPolicy : IReassignAppointmentPolicy
{
    private readonly IRequestContext _context;
    private readonly IAppointmentRepository _appointmentRepo;
    private readonly IStaffRepository _staffRepo;

    public ReassignAppointmentPolicy(
    ...
    public async Task EnsureCanReassignAsync(ReassignAppointmentCommand command, CancellationToken ct)
    {
