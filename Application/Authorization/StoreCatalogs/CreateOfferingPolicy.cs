...
public sealed class CreateOfferingPolicy : ICreateOfferingPolicy
{
    private readonly IRequestContext _context;
    private readonly IStaffRepository _repo;

    public CreateOfferingPolicy(IRequestContext context, IStaffRepository repo)
    {
        _context = context;
        _repo = repo;
    }

    public async Task EnsureCanCreateAsync(CreateOfferingCommand command, CancellationToken ct)
    {
