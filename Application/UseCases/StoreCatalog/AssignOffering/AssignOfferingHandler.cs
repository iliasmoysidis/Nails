...
public sealed class AssignOfferingHandler : ICommandHandler<AssignOfferingCommand>
{
    ...
    public async Task Handle(AssignOfferingCommand command, CancellationToken ct)
    {
        ...
        _service.AssignOffering(catalog, staff, _currentUser.UserId, command.ProfessionalId, command.OfferingId);
